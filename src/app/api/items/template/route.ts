...
// GET /api/items/template - Download Excel template for Items import
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    ws['!cols'] = Array.from({ length: Object.keys(templateData[0]).length }, () => ({ wch: 24 }));
    ...
    console.error('Items template generation error:', e);

...
export function DepartmentForm({
  ...
  async function onSubmit(formData: FormValues) {
    ...
    try {
      if (mode === 'create') {
        ...
        const res = await apiPost('/api/departments', payload);
        ...
        const res = await apiPatch(`/api/departments/${initial.id}`, payload);
  ...
  return (
    <Form {...form}>
      <AppCard>
        <AppCard.Header>
          <AppCard.Title>{isCreate ? 'Create Department' : 'Edit Department'}</AppCard.Title>
          <AppCard.Description>
            {isCreate ? 'Add a new department to the master data.' : 'Update department information.'}
          </AppCard.Description>
        </AppCard.Header>

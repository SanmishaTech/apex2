...
type CommercialApprovalOverallSiteBudgetPageProps = {
  params: Promise<{ siteId: string; id: string }>;
};

export default function CommercialApprovalOverallSiteBudgetPage({
  params,
}: CommercialApprovalOverallSiteBudgetPageProps) {
  useProtectPage();

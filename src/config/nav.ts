    ...
    children: [
      {
        ...
        href: "/cashbooks",
        icon: FileText,
        permission: PERMISSIONS.VIEW_CASHBOOKS,
      },
      {
        ...
        children: [
          {
            ...
            icon: FileText,
            permission: PERMISSIONS.VIEW_CASHBOOK_BUDGET_REPORT,
          },
          {
            title: "Daily Cashbook Report",
            href: "/reports/daily-cashbook",
            icon: FileText,
            permission: PERMISSIONS.VIEW_DAILY_CASHBOOK_REPORT,
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            icon: FileText,
            permission: PERMISSIONS.VIEW_OVERALL_BUDGET_REPORT,
          },
          {
            title: "Material Receiving Report",
            href: "/reports/material-receiving-report",
            icon: FileText,
            permission: PERMISSIONS.VIEW_MATERIAL_RECEIVING_REPORT,
          },
          {
            title: "Budget Planning Report",
            href: "/reports/budget-planning",
            icon: FileText,
            permission: PERMISSIONS.VIEW_BUDGET_PLANNING_REPORT,
          },
        ],
      },
    ],
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: FileText,
        permission: PERMISSIONS.VIEW_SUB_CONTRACTOR_WORK_ORDERS,
      },
      {
        title: "Sub Contractor Invoices",
        href: "/sub-contractor-invoices",
        icon: Receipt,
        permission: PERMISSIONS.VIEW_SUB_CONTRACTOR_INVOICES,
      },
      {
        title: "Sub Contractor WO Bills",
        href: "/sub-contractor-work-order-bills",
        icon: FileText,
        permission: PERMISSIONS.VIEW_SUB_CONTRACTOR_WORK_ORDER_BILLS,
      },
    ],
  },
